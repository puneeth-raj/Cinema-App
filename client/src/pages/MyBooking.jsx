...
const MyBooking = () => {
  ...
  return !isLoading?(
    ...
    <div className='relative px-6 md:px-16 lg:px-40 pt-40 min-h-[80vh]'>
            ...
            bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-3xl">
              ...
              <div className="flex flex-col md:items-end md:text-right justify-between p-4">
                ...
                <div className="text-sm">
                  <p className=""><span className='text-grry-400'>Total Tickets:</span> {item.bookedSeats.length}</p>
                  <p className=""><span className='text-grry-400'>Seat Number:</span> {item.bookedSeats.join(", ")}</p>
                </div>
              </div>
