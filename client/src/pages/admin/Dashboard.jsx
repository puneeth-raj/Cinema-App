   ...
   <div className="relative flex flex-wrap gap-4 mt-6">
              ...
              <div className="flex flex-wrap gap-4 w-full">
                  {dashboardCards.map((card, index) => (
                       ...
                       justify-between px-4 ру-3 bg-primary/10 border
      ...
      {dashboardData.activeShows.map((show) => (
         ...
         h-full pb-3 bg-primary/10 border border-primary/20
          hover:-translate-y-1 transition duration-300">
             ...
             <div className="flex items-center justify-between рх-2">
                 <p className="text-1g font-medium">{currency} {show.showPrice}</p>
