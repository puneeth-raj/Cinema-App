...
return toast("Missing required fields")
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <p className="mt-10 text-1g font-medium">Now Playing Movies</p>
...
p-2 bg-black/70 w-full absolute bottom-0 left-0"
    ...
    rounded-1g"
        ...
        text-white рх-3 ру-2 text-sm rounded-lg hover:bg-primary
        cursor-pointer"
          >
            Add Time
          </button>
                ...
                <div className="flex flex-wrap gap-2 mt-1 text-sm">
                  {times.map((time) => (
                    <div
                      key={time}
                      className="border
                                  border-primary px-2 ру-1 flex items-center
                                  rounded"
                    >
                      <span>{time}</span>
                      <DeleteIcon
      ...
      <button onClick={handleSubmit} disabled={addingShow} className="bg-primary text-white px-8 ру-2 mt-6 rounded
