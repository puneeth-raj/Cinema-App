...
const HeroSection = () => {
  ...
  return (
   <div className='flex flex-col items-start justify-center gap-4 рх-6 md:px-16
1g:px-36 bg-[ur1("/backgroundImage.png")] bg-cover bg-center h-screen'>
...
<button onClick={()=> navigate('/movies')} className="flex items-center gap-1 px-6 ру-3 text-sm bg-primary
