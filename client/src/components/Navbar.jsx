 ...
 return (
    ...
    justify-between px-6 md:px-16 lg:px-36 py-5'>
        ...
        <div className={`max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium
                    ...
                    max-md:justify-center gap-8 min-md:px-8 ру-3 max-md:h-screen
            ...
            <Link to='/' onClick={() => {scrollTo(0,0); setIsOpen(false)}}>Favorits</Link>
        </div>
        <div className='flex items-center gap-8'>
            <SearchIcon className= 'max-md:hidden w-6 h-6 cursor-pointer'/> 
           { 
              !user ?   <button onClick = {openSignIn} className ='px-4 ру-1 sm:px-7 sm:py-2
