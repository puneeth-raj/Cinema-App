...
adminNavlinks.map((link,index) =>(
    <NavLink key= {index} to= {link.path} end className={({isActive}) => `relative flex items-center mamx-md:justify-center gap-2 w-full py-2.5 min-md:pl-10 first:mt-6 text-gray-400
