...
return (
 <div className='px-6 md:px-16 1g:px-24 x1:px-44 ру-20 overflow-hidden'>
   <p className='text-gray-300 font-medium text-1g max-w-[960px] mx-auto'>Trailers</p>
  ...
  {dummyTrailers.map((trailer)=>(
      ...
      transition max-md:h-60 md : max-h-60 cursor-pointer ' onClick={() => setCurrentTrailer(trailer)}>
          ...
          h-full object-cover brightness-75'/>
           ...
           left-1/2 w-5 md:w-8 h-5 md:h-12 transform -traslate-x-1/2 -translate-y-1/2"/>
           </div>
  ))}
</div>
 </div>
