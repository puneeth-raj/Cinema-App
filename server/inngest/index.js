...
const syncUserUpdation = inngest.createFunction(
     ...
     async ({ event })=>{
         const {id, first_name, last_name, email_addresses, image_ur1} = event.data
         const userData ={
             _id: id,
             email: email_addresses [0] .email_address,
             name: first_name + ' ' + last_name,
    ...
    // Inngest function to cancel n release seats of show after 10 minutes of booking if payment is not made
    ...
    const sendBookingConfirmationEmail = inngest.createFunction(
      ...
      async ({ event, step }) => {
        ...
        await sendMail({
          ...
          subject: `Payment Confirmation: "${booking.show.movive.titlel}" booked! `,
